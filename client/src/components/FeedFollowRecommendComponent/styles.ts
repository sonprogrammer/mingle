...
export const FeedFollowRecommendContainer = tw.div`flex flex-col items-center border p-14 border-solid border-gray-300 bg-white h-max w-1/3 ml-auto mr-auto border-2 border-gray-200 my-10`;
